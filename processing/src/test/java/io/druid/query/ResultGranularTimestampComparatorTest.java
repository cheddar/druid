...
public class ResultGranularTimestampComparatorTest
{
  ...
  public void testCompareAll()
  {
    ...
    Assert.assertEquals(new ResultGranularTimestampComparator<Object>(QueryGranularity.ALL, descending).compare(r1, r2), 0);
  }
  ...
  public void testCompareDay()
  {
    ...
    Assert.assertEquals(new ResultGranularTimestampComparator<Object>(day, descending).compare(res, same), 0);
    Assert.assertEquals(new ResultGranularTimestampComparator<Object>(day, descending).compare(res, greater), descending ? 1 : -1);
    Assert.assertEquals(new ResultGranularTimestampComparator<Object>(day, descending).compare(res, less), descending ? -1 : 1);
  }
  ...
  public void testCompareHour()
  {
    ...
    Assert.assertEquals(new ResultGranularTimestampComparator<Object>(hour, descending).compare(res, same), 0);
    Assert.assertEquals(new ResultGranularTimestampComparator<Object>(hour, descending).compare(res, greater), descending ? 1 : -1);
    Assert.assertEquals(new ResultGranularTimestampComparator<Object>(hour, descending).compare(res, less), descending ? -1 : 1);
  }
}
